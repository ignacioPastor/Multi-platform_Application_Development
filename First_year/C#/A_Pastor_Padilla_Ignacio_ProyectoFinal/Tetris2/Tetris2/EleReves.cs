...
// Esta clase caracteriza la pieza EleReves, su color particular y la distribución particular de
...
namespace Tetris2
{
    class EleReves : Pieza
    {
        public EleReves()
        {

        }
        public EleReves(int x, int y)
        {
            DarPropiedades();
        ...
        public void DarPropiedades()
        {
            for (int i = 0; i < 4; i++)
            {
                posicion[i].AColor = Tetraedro.Color.rojo;
            }
        }
