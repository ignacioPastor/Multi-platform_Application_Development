...
// Esta clase caracteriza la pieza ZetaReves, su color particular y la distribución particular de
...
namespace Tetris2
{
    class ZetaReves : Pieza
    {
        public ZetaReves()
        {

        }
        public ZetaReves(int x, int y)
        {
            DarPropiedades();
        ...
        public void DarPropiedades()
        {
            for (int i = 0; i < 4; i++)
            {
                posicion[i].AColor = Tetraedro.Color.magenta;
            }
        }
    }
}
